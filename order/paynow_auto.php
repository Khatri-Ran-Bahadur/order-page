...
$sql = @mysqli_query($dbcon," SELECT * FROM orders_orders WHERE order_id = '$order_id' AND payment_status = '0' ");
	...
	echo 'Invalid Request';
		...
		echo '
		<form method="POST" action="'.$siteurl.'/order/paynow_auto.php" id="paymentProcessor">
		...
		<input type="hidden" name="complete" value="Continue">
		</form>';?>

		<img src="ajax-loader.gif" /><br />		    
		        
		<p>
		You are being redirected to <?=$dtype;?>.<br>
		Deposited funds will be added to your balance as soon as we receive notification from <?=$dtype;?>.
		</p>
