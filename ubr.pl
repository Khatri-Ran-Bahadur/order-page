...
#	Revision: 3.8
#	Date: 10:02 PM November 26, 2009
...
#**********************************************************************************************************************************
my $TEMP_DIR        = '/home/primeess/tmp/ubr_temp/';                    # * ATTENTION * : The $TEMP_DIR value MUST be duplicated in the "ubr_ini.php" file
...
if($config{'redirect_after_upload'} > 0){
	...
	print "parent.UberUpload.redirectAfterUpload('$redirect_url', $embedded_upload_results);\n";
	print "</script>\n";
}
else{
	#####################################################################################################################################
	...
	print "content-type:text/html; charset=utf-8\n\n";
	print "<script language=\"javascript\" type=\"text/javascript\">\n";
	print "parent.UberUpload.showCGIOutput('Upload Finished', 1);\n";
	print "</script>\n";
}
...
sub kak{
	...
	print "			<script language=\"javascript\" type=\"text/javascript\">if(parent.frames.length!=0){parent.UberUpload.showEmbeddedUploadResults();}</script>\n";
	print "		<\/head>\n";
